...
dir_load = "/home/zxf/PycharmProjects/CIKM/CNN_new/run/1497222981/checkpoints/model-3000"
...
def net(image, i):
    ...
    with tf.variable_scope(name):
        ...
        conv3 = slim.conv2d(inputs = pool2, num_outputs = 256, kernel_size= [3, 3],
                            stride = 1, scope = 'conv3')

        conv4 = slim.conv2d(inputs = conv3, num_outputs = 512, kernel_size= [3, 3],
