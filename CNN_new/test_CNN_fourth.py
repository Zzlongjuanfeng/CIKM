...
import time
import numpy as np
from CNN_predict_fourth import net
import csv
...
dir_load = "/home/zxf/PycharmProjects/CIKM/CNN_new/run/1498160635/checkpoints/model-27000"
...
print(fc1_all.shape)
y_conv = slim.fully_connected(inputs=fc1_all, num_outputs=20, activation_fn=None, scope='fc2')
